  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        gold: 'border-transparent bg-yellow-500 text-white hover:bg-yellow-500/80',
        // status colors
    ...
    return (
      <span
        className={cn(
          ...
          'relative inline-flex items-center justify-center min-w-[20px] h-5 px-1 text-xs rounded-full',
          className
        )}
        {...props}
      >
